      ...
      <Center>
        <Box w={{ sm: '90%', md: '70%', lg: '55%' }}>
          ...
          <OrderedList spacing={2} pt={2}>
            ...
            <ListItem>
              管理者、本サービスの他の利用者またはその他の第三者に対する詐欺または脅迫行為
            </ListItem>
            <ListItem>
              公序良俗に反する行為
            </ListItem>
            ...
            <ListItem>
              管理者が事前に許諾しない本サービス上での宣伝、広告、勧誘、または営業行為
            </ListItem>
            <ListItem>
              本サービスの他の利用者の情報の収集
            </ListItem>
            <ListItem>
              管理者、本サービスの他の利用者またはその他の第三者に不利益、損害、不快感を与える行為
            </ListItem>
            <ListItem>
              反社会的勢力等への利益供与
            </ListItem>
          ...
          <OrderedList spacing={2} pt={2}>
            ...
            <OrderedList spacing={2} pl={5}>
              ...
              <ListItem>
                管理者からの問い合わせその他の回答を求める連絡に対して30日以上応答がない場合
              </ListItem>
              <ListItem>
                第2条第2項各号に該当する場合
              </ListItem>
          ...
          <OrderedList spacing={2} pt={2}>
            <ListItem>
              管理者の都合により、本サービスの内容を変更し、または提供を終了することができます。
            </ListItem>
            <ListItem>
              本サービスの提供を終了する場合、管理者は登録ユーザーに事前に通知するものとします。
            </ListItem>
          </OrderedList>
